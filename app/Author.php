...
class Author extends Model
{
    ...
    // Qui vado ad inserire il TIPO di  relazione (OneToMany) esistente tra la tab 'authors', relativa a questo Model, e la tab 'posts'(contenete, la FK collegata all'id di 'authors'). Partendo dal presente Model 'Author' dobbiamo arrivare al Model 'Post'. Definisco, dunque, una FX con un nome che identifichi la tab ('posts') relativa all'altro Model (il Post).
